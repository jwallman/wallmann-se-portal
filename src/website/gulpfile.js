...
// Clean vendor
function clean() {
  return del(["./vendor/", "../main/resources/static/"], {force: true});
}
...
// dist task
function dist() {
    const f = filter(['**/*.min.js', '**/*.min.css', '**/img/**/*', '**/index.html', '**/vendor/**/*'], {passthrough: true});
    return gulp.src(['./css/**/*', './js/**/*', './img/**/*', './index.html', './vendor/**/*'], {base: './'})
        .pipe(f)
        .pipe(gulp.dest('../main/resources/static'));
};
